...
export var translates = {
    ...
    // StealthLink
    stealthlinkServerSettings: {
        "ru": "Настройки StealthLink",
        "": "StealthLink Settings",
    },
    stealthlinkPsk: {
        "ru": "Pre-Shared Key (PSK)",
        "": "Pre-Shared Key (PSK)",
    },
    stealthlinkSni: {
        "ru": "Маскировочный домен (SNI)",
        "": "SNI Hostname",
    },
    stealthlinkTransport: {
        "ru": "Транспорт (tls/quic)",
        "": "Transport Protocol (tls/quic)",
    },
    stealthlinkPath: {
        "ru": "Секретный путь HTTP",
        "": "Secret HTTP Path",
    },
    stealthlinkFingerprint: {
        "ru": "uTLS Отпечаток (Fingerprint)",
        "": "uTLS Fingerprint",
    },
    stealthlinkInsecure: {
        "ru": "Игнорировать проверку сертификата (Insecure)",
        "": "Allow Insecure (Disable cert check)",
    },
    stealthlinkNoPadding: {
        "ru": "Отключить паддинг (No Padding)",
        "": "Disable Padding",
    },
    stealthlinkNoStealth: {
        "ru": "Отключить Stealth функции",
